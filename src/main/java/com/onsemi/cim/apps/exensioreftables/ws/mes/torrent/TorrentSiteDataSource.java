...
public class TorrentSiteDataSource {
    ...
    public TorrentSiteDataSource(String site, String driverClassName, String connectionString, String dbUsername, String dbPassword, String sqlLtmProductReplacement) {
        this.site = site;
